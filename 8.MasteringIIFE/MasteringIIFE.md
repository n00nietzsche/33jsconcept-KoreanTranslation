...
2. 또한 자바스크립트 축소기(minifiers)는 안전하게 함수 안에 선언된 파라미터의 이름을 축소할 수 있습니다. 우리가 만일 이러한 파라미터를 넘기지 않는다면, 축소기는 ***document***나 ***jQuery***에 대한 직접적인 참조를 축소할 수 없습니다. 왜냐하면 그들이 이 함수 스코프 밖에 있으니까요.
